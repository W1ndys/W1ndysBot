...
async def ArkSharePeer(websocket, group_id, user_id, phoneNumber):
    ...
    try:
        ...
        await websocket.send(json.dumps(message))
        logger.info("[API]已执行获取推荐好友/群聊卡片")
        return True
    except Exception as e:
