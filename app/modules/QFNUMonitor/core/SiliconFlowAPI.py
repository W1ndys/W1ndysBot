...
7. 如果内容过少、无意义或只有附件/PDF提示信息，请回复"该通知为附件形式，请点击链接查看原文"
8. 如果内容主要是表格数据或格式混乱难以理解，尽量提取关键信息，无法提取则提示查看原文"""
...
4. 摘要长度控制在400字以内
5. 直接输出摘要内容，不要添加任何前缀
6. 如果内容过少、无意义或只有附件/PDF提示信息，请回复"该页面为附件形式，请点击链接查看原文"
7. 如果内容主要是表格数据或格式混乱难以理解，尽量提取关键信息，无法提取则提示查看原文"""
