...
COMMANDS = {
    ...
    f"{LOTTERY_COMMAND}阳光/{LOTTERY_COMMAND}雨露": f"抽奖功能，花费{LOTTERY_COST}个数值，随机获得{LOTTERY_REWARD_MIN}-{LOTTERY_REWARD_MAX}个数值，支持倍率：抽阳光 10（每群每用户每分钟限1次，且每日最多{DAILY_LOTTERY_LIMIT}次）",
